    ...
    <>
        <div className={styles.pageContainer}>
            <div className={styles.pageWrapper}>
                <h1 className={styles.headerTitleBag}> Мемориальный комплекс «Багратион» </h1>
                <p className={styles.headerSubtitleBag}>Память народа </p>
        ...
        <div>
            <h2 className={styles.title}>Историческая справка</h2>
